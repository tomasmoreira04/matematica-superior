...
\begin{document}
	...
	En este ejercicio hay que tener cuidado de NO considerar el $-1$ como el módulo del número complejo. Tener siempre presente que el módulo siempre es un número positivo, a lo sumo $0$.\\
