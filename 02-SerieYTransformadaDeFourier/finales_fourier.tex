...
\begin{document}
	...
	$\displaystyle b_{n}= \frac{2}{1} \int_{0}^{1} x\cos(n\pi x) dx=2\left[\frac{\cos(n\pi x)}{n^2\pi^2}+\frac{x\sen(n\pi x)}{n\pi}\right]_{0}^{1}$
	
	Evaluamos:
	
	$\displaystyle b_{n}=2\left[\frac{\cos(n\pi)}{n^2\pi^2} + \frac{\sen(n\pi)}{n\pi} - \frac{\cos(0)}{n^2\pi^2} + \frac{0\sen(0)}{n\pi}\right]=\displaystyle b_{n}=2\left[\frac{\cos(n\pi)}{n^2\pi^2} + \frac{\sen(n\pi)}{n\pi} - \frac{1}{n^2\pi^2}\right]$
	...
	La expresión queda entonces: $\displaystyle b_{n}=\frac{(-1)^n - 1}{n^2\pi^2}$
	
	La podemos pulir aún más a esta expresión, si $n$ es par, vemos que $b_{n}=0$, en cambio si $n$ es impar, nos queda $\displaystyle b_{n}=-\frac{2}{n^2\pi^2}$.
	
	Luego, con este último análisis la podemos reescribir de esta manera:
	
	$\displaystyle b_{k}=-\frac{2}{(2k+1)^2\pi^2}$
	
	La serie de $g$ es entonces: $\displaystyle Sg(x)=\sum_{0}^{\infty}-\frac{2}{(2k+1)^2\pi^2} \sen(n\pi x)$
	...
	Por último: \fcolorbox{black}{yellow}{$\displaystyle Sf(x)=S(x)=3+ \sum_{0}^{\infty}-\frac{2}{(2k+1)^2\pi^2} \sen(n\pi x)$}
	\section{Ejercicio 6}
